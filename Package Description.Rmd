...
```
having the column number associated to the name you want to change (i.e., instead of [1]) or by changing it manually in the data. The same follows for *Gene*, *Frequency* and *Selective_pressure*.  
...
```{r, eval=FALSE}
multigen_c_hyper(paper = "Author2018", environment = "YPD", speices = "Sac", generations = c("0", "100", "500", "1000", "1500"))  
```
...
### Data  
The data must have more than one generation, a column called *Populations*, a column called *Gene*, and *Frequency* associated with the Gene, Population and generation. The data can have other columns as well, but as long as we have the main ones named above, then the function will work.      
