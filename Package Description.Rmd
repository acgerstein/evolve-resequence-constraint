...
knitr::include_graphics("figures/Sandberg.1.png")
```
...
```{r, echo=FALSE, out.width = '75%', fig.pos = "H", fig.align="center"}
knitr::include_graphics("figures/Wannier.1.png")
```
...
```{r, echo=FALSE, out.width = '75%', fig.pos = "H", fig.align="center"}
knitr::include_graphics("figures/Wannier.2.png")
```
...
```{r, echo=FALSE, out.width = '75%', fig.pos = "H", fig.align="center"}
knitr::include_graphics("figures/Wannier.3.png")
```
...
i.e    
```{r, echo=FALSE, out.width = '75%', fig.pos = "H", fig.align="center"}
knitr::include_graphics("figures/Tenaillon.1.png")
```
```{r, echo=FALSE, out.width = '75%', fig.pos = "H", fig.align="center"}
knitr::include_graphics("figures/Tenaillon.2.png")
```
...
```{r, echo=FALSE}
print("data <- data %>% 
  transmute(Gene = data$Gene, Population = data$Population, Details = data$Details, `500` = `500 I1 R1`+`500 I2 R1`, `1000` = `1000 I1 R1`+`1000 I2 R1`, `1500` =`1500 I1 R1`+`1500 I2 R1`, `2000` = `2000 I1 R1`+`2000 I2 R1`, `5000` = `5000 I1 R1`+`5000 I2 R1`, `10000` = `10000 I1 R1`+`10000 I2 R1`, `15000` = `15000 I1 R1`+`15000 I2 R1`, `20000` = `20000 I1 R1`+`20000 I2 R1`, `30000` = `30000 I1 R1`+`30000 I2 R1`, `40000` = `40000 I1 R1`+`40000 I2 R1`, `50000` = `50000 I1 R1`+`50000 I2 R1`) %>% replace(is.na(.), 0)")
```
...
```{r, echo=FALSE, out.width = '75%', fig.pos = "H", fig.align="center"}
knitr::include_graphics("figures/Tenaillon.3.png")
```
...
multigen_c_hyper("Author2018, "YPD", "Sac", c("0", "100", "500", "1000", "1500"))  
...
i.e:
```{r, echo=FALSE, out.width = '75%', fig.pos = "H", fig.align="center"}
knitr::include_graphics("figures/Lang.1.png")
```
...
i.e:
```{r, echo=FALSE, out.width = '75%', fig.pos = "H", fig.align="center"}
knitr::include_graphics("figures/Lang.2.png")
```
...
i.e:
```{r, echo=FALSE, out.width = '75%', fig.pos = "H", fig.align="center"}
knitr::include_graphics("figures/Jerison.1.png")
```
...
i.e:
```{r, echo=FALSE, out.width = '75%', fig.pos = "H", fig.align="center"}
knitr::include_graphics("figures/Jerison.2.png")
```
The analysis will be automatically saved into the data-out folder that you created beforehand.  
...
i.e:
```{r, echo=FALSE, out.width = '75%', fig.pos = "H", fig.align="center"}
knitr::include_graphics("figures/Sandberg.2.png")
```
...
i.e:
```{r, echo=FALSE, out.width = '75%', fig.pos = "H", fig.align="center"}
knitr::include_graphics("figures/Sandberg.3.png")
```
The analysis will be automatically saved into the data-out folder that you created beforehand.  
...
i.e:
```{r, echo=FALSE, out.width = '75%', fig.pos = "H", fig.align="center"}
knitr::include_graphics("figures/McCloskey.1.png")
```
...
i.e:
```{r, echo=FALSE, out.width = '75%', fig.pos = "H", fig.align="center"}
knitr::include_graphics("figures/McCloskey.2.png")
```
The analysis will be automatically saved into the data-out folder that you created beforehand.  
